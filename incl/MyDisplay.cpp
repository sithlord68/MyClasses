...
/*   Updated: 2026/02/20 20:50:59 by pjolidon         ###   ########.fr       */
/*                                                                            */
/******************************************************************************/
...
MyDisplay::MyDisplay(std::ostream &stream):
	_nbElems( 0 ),
	_ended( false ),
	_autoSpace( true )
{
...
MyDisplay &MyDisplay::operator<<(unsigned char value)
{
	if (this->_autoSpace && this->_nbElems++)
		*this->_iOutput << " ";
	*this->_iOutput << value;
...
MyDisplay &	MyDisplay::operator<<(std::size_t value)
{
	if (this->_autoSpace && this->_nbElems++)
		*this->_iOutput << " ";
	*this->_iOutput << value;
...
MyDisplay &	MyDisplay::operator<<(long value)
{
	if (this->_autoSpace && this->_nbElems++)
		*this->_iOutput << " ";
	*this->_iOutput << value;
